...
/*
blackContainer = document.querySelector('.MuiBox-root .jss59')
blackContainerDown = document.querySelector('.MuiBox-root .jss47')

clasiContainer = document.querySelector('.MuiBox-root .jss60')
clasiContainerDown = document.querySelector('.MuiBox-root .jss60')

 .MuiButtonBase-root{display:none} 
 */


var card_black = document.querySelector('.car-one')
...
card_black.appendChild(buttonBlack)


var card_clasicc = document.querySelector('.car-two')
...
card_clasicc.appendChild(buttonClasica)
